...
//draw_set_halign(fa_right) draw_text(__view_get( e__VW.WView, 0 )/2+string_width(string_hash_to_newline(features[current]))/2+1,__view_get( e__VW.HView, 0 )*0.87+1,string_hash_to_newline("NO WEAPONS"))
