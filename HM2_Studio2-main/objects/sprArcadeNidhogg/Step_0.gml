if sprite_index=sprELisArcadeNidhogg {
...
sound_play(sndTaser)
sprite_index=sprArcadeNidhoggBroken
image_index=0
image_speed=0
...
if sprite_index=sprArcadeNidhoggBroken {
if life>0 {
life-=1 
if round(random(3))=2 {
...
} else {image_speed=0 if sprite_index=sprArcadeNidhoggBroken image_index=0}
}
