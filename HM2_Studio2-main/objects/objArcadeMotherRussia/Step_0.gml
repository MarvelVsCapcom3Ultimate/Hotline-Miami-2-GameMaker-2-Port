if sprite_index=sprELisArcadeMotherRussia {
...
if sprite_index=sprArcadeMotherRussiaBroken {
if life>0 {
life-=1 
if round(random(3))=2 {
...
} else {image_speed=0 if sprite_index=sprArcadeMotherRussiaBroken image_index=0}
}
