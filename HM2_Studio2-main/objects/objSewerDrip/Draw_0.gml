...
draw_set_alpha(0.5)
draw_line_width_color(x+lengthdir_x(height*(dist*0.005),dir),y+lengthdir_y(height*(dist*0.005),dir),x+lengthdir_x((height+10)*(dist*0.005),dir),y+lengthdir_y((height+10)*(dist*0.005),dir),1,c_lime,c_green)
draw_set_alpha(1)
}
