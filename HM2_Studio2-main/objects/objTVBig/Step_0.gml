if scrMovingPlayerExists() and (sprite_index=sprTVBigBreak or sprite_index=sprElisTVBig) {
...
if sprite_index=sprTVBigBreak or sprite_index=sprTVBigBroken {
if life>0 {
life-=1
if round(random(3))=2 {
...
if round(random(2))=1 {
my_id=instance_create(x-8+random(16),y-8+random(16),objElectricSpark)
my_id.direction=point_direction(x,y,my_id.x,my_id.y)
my_id.speed=3+random(2)
my_id.image_angle=my_id.direction
}
} else {image_speed=0 if sprite_index=sprTVBigBreak image_index=0}
}
