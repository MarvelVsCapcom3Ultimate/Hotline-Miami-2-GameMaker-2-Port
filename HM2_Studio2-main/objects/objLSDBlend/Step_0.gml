...
scale=-0.75+lengthdir_x(0.25,dir)//0.5+lengthdir_x(2,dir)
...
if abs(scale)=0 draw_surface_ext(surf2,-0.5+random(1),-0.5+random(1),1,1,0,c_white,1) else draw_surface_ext(surf2,scale-0.5+random(1),scale-0.5+random(1),1-(scale/surface_get_width(surf2))*2,1-(scale/surface_get_height(surf2))*2,0,merge_color(c_white,make_color_hsv(h,255,255),0.1),1)
texture_set_interpolation(0)
if room=rmLSDRoof nothing=1 else {
draw_set_blend_mode(bm_subtract)
repeat (60) {
draw_sprite_ext(sprDisappear,random(7),round(random(room_width)),round(random(room_height)),0.25+random(0.25),0.25+random(0.25),random(360),c_white,1)
}
...
with objGore draw_surface_ext(surf,0,0,0.5,0.5,0,c_white,1)
with objLSDBushVines draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
with objShard draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
with objZebraShard draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
with objZebraParts draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
with objSwanChunks draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
with objSwanBrainChunk draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
with objIntestine draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
with objBrains draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
with objMafiaMovingCorpse draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
with objMafiaCorpse {
i=0
...
if object_index=objPlayerDieDog {
if dog=1 draw_sprite_ext(sprite,index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
}
}
with objBodyPiece draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
with objDeadBody {
visible=0
draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
}
...
with objZebraBoss draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)

with objLSDSmoke {
if depth=1 draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
}
...
draw_sprite_ext(sprite_index,image_index,x+myx,y+myy,image_xscale+shake*0.2,image_yscale+shake*0.2,image_angle,image_blend,image_alpha)
draw_sprite_ext(sprTigerBossHeadAttack,index,x+myx,y+myy,image_xscale+shake*0.2,image_yscale+shake*0.2,image_angle,image_blend,image_alpha)
d3d_set_fog(0,0,0,0)
}
draw_sprite_ext(sprite_index,image_index,x+height*0.5,y+height,image_xscale,image_yscale,image_angle,c_black,image_alpha*0.5)
draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
draw_sprite_ext(sprTigerBossHeadAttack,index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
if dead=1 {
amount=(shake-8)*0.5
if amount<0 amount=0
d3d_set_fog(1,make_color_hsv(random(255),random(255)*((10-shake)*0.1),255),0,0)
draw_sprite_ext(sprite_index,image_index,x,y,image_xscale+shake*0.1,image_yscale+shake*0.1,image_angle,image_blend,1)
draw_sprite_ext(sprTigerBossHeadAttack,index,x,y,image_xscale+shake*0.1,image_yscale+shake*0.1,image_angle+shake*2,image_blend,1)
d3d_set_fog(0,0,0,0)
draw_set_alpha(1)
}
}
...
with objLSDBush draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
with objPalmTreeLSD {
if on=1 {
i=0
repeat (branches) {
