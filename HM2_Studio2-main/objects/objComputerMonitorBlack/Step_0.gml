if scrMovingPlayerExists() and (sprite_index=sprELisComputerMonitorBlack or sprite_index=sprComputerMonitorBlackBreak) {
...
if sprite_index=sprComputerMonitorBlackBreak or sprite_index=sprComputerMonitorBlackBroken {
if life>0 {
life-=1 
if round(random(3))=2 {
...
} else {image_speed=0 if sprite_index=sprComputerMonitorBlackBreak image_index=0}
}
