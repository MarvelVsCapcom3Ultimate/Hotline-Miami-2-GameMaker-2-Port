...
legsprite=sprZebraLegs

if aimon=1 {
dir=point_direction(x,y,global.mousex,global.mousey)
}
if sprite_index=sprZebraRoll nothing=1 else draw_sprite_ext(legsprite,legindex,x+1,y+1,image_xscale,image_yscale,legdir,c_black,0.5)
draw_sprite_ext(sprite_index,image_index,x+1,y+1,image_xscale,left,dir,c_black,0.5)
if sprite_index=sprZebraRoll nothing=1 else  draw_sprite_ext(legsprite,legindex,x,y,image_xscale,image_yscale,legdir,image_blend,image_alpha)
