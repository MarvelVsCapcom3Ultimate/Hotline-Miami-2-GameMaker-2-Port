...
draw_sprite_general(sprMoon,0,0,0,160,160,room_width/2-40,room_height/4-40,0.5,0.5,-__view_get( e__VW.Angle, 0 ),c_red,c_red,merge_color(c_orange,c_yellow,0.5+lengthdir_x(0.5,dir)),merge_color(c_orange,c_yellow,0.5+lengthdir_x(0.5,dir)),1)
...
dir+=2
if x<room_width x+=0.15 else x-=room_width
}
with objSkyline2 {
draw_sprite_ext(sprite_index,0,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
draw_sprite_general(sprite_index,1,0,0,160,64,x,y,image_xscale,image_yscale,image_angle,merge_color(c_orange,c_red,0.5+lengthdir_x(0.5,dir*0.7)),merge_color(c_orange,c_red,0.5+lengthdir_x(0.5,dir+110)),merge_color(c_olive,c_maroon,0.5+lengthdir_x(0.5,dir*0.8)),merge_color(c_olive,c_maroon,0.5+lengthdir_x(0.5,dir*0.8+110)),image_alpha)
...
draw_set_blend_mode(bm_normal)
dir+=2
if x<room_width+160 x+=0.2 else x-=room_width+160
}
draw_set_blend_mode(bm_add)
...
if index1<28.15 color=merge_color(c_black,c_maroon,(index1+1)/30) else color=merge_color(c_maroon,c_black,((index1+1)-28)*0.065)
...
if index2<28.15 color=merge_color(c_black,c_maroon,(index2+1)/30) else color=merge_color(c_maroon,c_black,((index2+1)-28)*0.065)
...
draw_set_blend_mode(bm_normal)
with objPalmTrees {
//draw_sprite_general(sprPalmTrees,image_index,0,0,64,160,x,room_height/5,1,1,0,merge_color(c_maroon,c_dkgray,0.5+lengthdir_x(0.5,dir)),merge_color(c_maroon,c_dkgray,0.5+lengthdir_x(0.5,dir)),c_black,c_black,1)
draw_sprite_general(sprPalmTrees,image_index,0,0,64,160,x,room_height/5,1,1,0,merge_color(c_white,c_red,0.5+lengthdir_x(0.5,dir)),merge_color(c_white,c_red,0.5+lengthdir_x(0.5,dir)),c_maroon,c_maroon,0.7)
}
...
i=0
repeat (10) {
draw_sprite_general(sprPalmTrees,0,0,0,64,160,i*64,room_height/5,1,1,0,merge_color(c_maroon,c_black,0.25+lengthdir_x(0.25,dir+i*20)),merge_color(c_maroon,c_black,0.25+lengthdir_x(0.25,dir+30+i*20)),c_black,c_black,1)
i+=1
}
draw_set_blend_mode(bm_normal)*/
...
if c_amount>90 color2=merge_color(c_black,merge_color(c_blue,c_white,abs(lengthdir_y(1,c_amount))),abs(lengthdir_y(1,c_amount))) else color2=c_white
...
if scrCheckNewSong() scrSongVolume(c_amount*(1/180))
color1=merge_color(c_black,merge_color(c_aqua,c_white,0.5+lengthdir_x(0.5,c_amount)),0.5+lengthdir_x(0.5,c_amount))
if c_amount>90 color2=merge_color(c_black,merge_color(c_blue,c_white,abs(lengthdir_y(1,c_amount))),abs(lengthdir_y(1,c_amount))) else color2=c_white
draw_set_blend_mode(bm_subtract)
