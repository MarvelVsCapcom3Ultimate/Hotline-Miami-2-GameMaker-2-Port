dir+=0.25
color=merge_color(merge_color(merge_color(c_navy,c_purple,0.5+lengthdir_x(0.2,dir*3)),merge_color(c_teal,c_blue,0.5+lengthdir_x(0.5,dir*4.7)),0.25+lengthdir_x(0.25,dir*2)),c_black,0.75)
