if sprite_index=sprELisPowerPlantTerminal {
...
sound_play(sndTaser)
sprite_index=sprPowerPlantTerminalBroken
image_index=0
image_speed=0
...
if sprite_index=sprPowerPlantTerminalBroken {
if life>0 {
life-=1 
if round(random(3))=2 {
...
} else {image_speed=0 if sprite_index=sprPowerPlantTerminalBroken image_index=0}
}
