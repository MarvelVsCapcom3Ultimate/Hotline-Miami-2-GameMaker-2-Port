if sprite_index=sprElisArcadeGuns {
...
sound_play(sndTaser)
sprite_index=sprArcadeGunsBreak
image_index=0
image_speed=0
...
if sprite_index=sprArcadeGunsBreak {
if life>0 {
life-=1 
if round(random(3))=2 {
...
} else {image_speed=0 if sprite_index=sprArcadeGunsBreak image_index=0}
}
