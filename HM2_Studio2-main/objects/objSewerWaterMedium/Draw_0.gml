i=0
repeat (image_yscale) {
draw_sprite_ext(sprite_index,image_index,x+lengthdir_x(sprite_get_height(sprite_index)*i,image_angle-90),y+lengthdir_y(sprite_get_height(sprite_index)*i,image_angle-90),1,1,image_angle,image_blend,1)
i+=1
}
