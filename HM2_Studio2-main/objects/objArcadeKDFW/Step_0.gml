if sprite_index=sprElisArcadeKDFW {
...
sound_play(sndTaser)
sprite_index=sprArcadeKDFWBreak
image_index=0
image_speed=0
...
if sprite_index=sprArcadeKDFWBreak {
if life>0 {
life-=1 
if round(random(3))=2 {
...
} else {image_speed=0 if sprite_index=sprArcadeKDFWBreak image_index=0}
}
