if sprite_index=sprElisArcadeLuftrausers {
...
if sprite_index=sprArcadeLuftrausersBreak {
if life>0 {
life-=1 
if round(random(3))=2 {
...
} else {image_speed=0 if sprite_index=sprArcadeLuftrausersBreak image_index=0}
}
