...
if doorindex>0 doorindex-=0.2 else doorindex=0
}*/
...
objPlayer.x+=lengthdir_x(2,point_direction(objPlayer.x,objPlayer.y,x-lengthdir_x(23,image_angle),y-lengthdir_y(23,image_angle)))
objPlayer.y+=lengthdir_y(2,point_direction(objPlayer.x,objPlayer.y,x-lengthdir_x(23,image_angle),y-lengthdir_y(23,image_angle)))
} else {
