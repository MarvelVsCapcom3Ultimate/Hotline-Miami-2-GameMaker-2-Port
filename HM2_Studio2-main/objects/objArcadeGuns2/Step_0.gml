if sprite_index=sprELisArcadeGuns2 {
...
sound_play(sndTaser)
sprite_index=sprArcadeGuns2Broken
image_index=0
image_speed=0
...
if sprite_index=sprArcadeGuns2Broken {
if life>0 {
life-=1 
if round(random(3))=2 {
...
} else {image_speed=0 if sprite_index=sprArcadeGuns2Broken image_index=0}
}
