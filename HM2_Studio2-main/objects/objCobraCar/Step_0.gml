...
my_id=instance_create(x,y,objPlayerCobra)
my_id.active=0
...
if sprite_index=sprCobraCar {sound_play(sndCarStart) sprite_index=sprCobraCarStart image_index=0}
if sprite_index=sprCobraCarStart {
