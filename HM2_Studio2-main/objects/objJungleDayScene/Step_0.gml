...
if camount<1 {
color2=merge_color(c_white,c_white,camount)
color1=merge_color(c_white,c_white,camount)
} else {
color2=merge_color(c_white,c_white,camount-1)
color1=merge_color(c_white,c_lime,camount-1)
}
draw_clear_alpha(c_black,0)
...
draw_set_font(font1)
draw_set_color(merge_color(c_maroon,c_red,0.5+lengthdir_x(0.5,dir*0.3)))
...
draw_set_color(merge_color(c_red,c_white,0.5+lengthdir_x(0.5,dir*0.3)))
...
draw_text_transformed_color(room_width/2,room_height/2,string_hash_to_newline(global.title),0.8+i*0.005,0.8+i*0.005,lengthdir_x(2,dir*0.25+i*6),c_red,c_red,merge_color(c_orange,c_white,0.5+lengthdir_x(0.5,dir)),merge_color(c_orange,c_white,0.5+lengthdir_x(0.5,dir)),1)
surface_reset_target()
