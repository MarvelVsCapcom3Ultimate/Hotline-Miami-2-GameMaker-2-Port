function scrDrawREW() {
	...
	if rewline<40 rewline+=2
	i=0
	repeat (8) {
	repeat (24-i*2) {
	draw_sprite_ext(sprSmallWhiteDistortion,random(3),random(room_width),rewline-i-random(i*0.3),1,1,0,c_white,1-random(0.2))
	draw_sprite_ext(sprSmallWhiteDistortion,random(3),random(room_width),room_height-rewline+i+random(i*0.3),1,1,0,c_white,1-random(0.2))
	}
	i+=1
	}
