function scrDrawConversation() {
	...
	draw_sprite_ext(sprite,index,__view_get( e__VW.WView, 0 )-phonex+106+2,__view_get( e__VW.HView, 0 )/2+3,image_xscale,image_yscale,lengthdir_x(4,global.dir*1.67),c_black,0.5)
	draw_sprite_ext(sprite,index,__view_get( e__VW.WView, 0 )-phonex+106,__view_get( e__VW.HView, 0 )/2,image_xscale,image_yscale,lengthdir_x(4,global.dir*1.67),c_white,1)
	if blackx=45 {
