function scrDrawHood() {
	...
	draw_sprite_ext(sprSonMask,0,x+addx+1,y+addy+1,image_xscale,image_yscale*left,dir,c_black,0.25)
	draw_sprite_ext(sprSonMask,0,x+addx,y+addy,image_xscale,image_yscale*left,dir,image_blend,image_alpha)
