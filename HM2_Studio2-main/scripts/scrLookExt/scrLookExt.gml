function scrLookExt(argument0, argument1, argument2, argument3) {
	...
	if dist>argument3 return 1 else {
	...
	stop=0
	with objEditorDoorV {test=solid solid=1}
	scrMoveSolidOn()
	with objGlassPanel solid=0
	with objRenovationWallV solid=0
	with objRenovationWallH solid=0
	with objEditorSoftWallH solid=1
	with objEditorSoftWallV solid=1
