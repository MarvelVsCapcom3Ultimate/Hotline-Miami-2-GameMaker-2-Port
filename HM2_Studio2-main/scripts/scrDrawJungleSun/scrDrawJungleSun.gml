function scrDrawJungleSun() {
	if room=rmHotelPool or room=rmHotelLobby or room=rmHotelUpstairs or room=rmOceanSide or room=rmDayJungle1 or room=rmDayJungle2 or room=rmDayJungle3 or room=rmHotelOutside {
