function scrDrawAmmo() {
	...
	scrGetAmmoDraw()
	if global.ammo>0 ammostring=string(global.ammo) else ammostring="Empty"
	...
	draw_set_font(fntAmmo)
	if global.ammo>0 draw_sprite_ext(sprAmmoSymbols,global.ammotype,20+ammox,232,1,1,0,c_white,1)
	//ammo
