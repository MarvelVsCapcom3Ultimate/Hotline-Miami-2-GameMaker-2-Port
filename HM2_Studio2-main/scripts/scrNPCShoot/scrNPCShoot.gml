function scrNPCShoot(argument0) {
	if ammo>0 {
	//angle=direction
	...
	repeat (8) {
	my_id=instance_create(x+lengthdir_x(26,angle),y+lengthdir_y(26,angle),argument0)
	...
	my_id.speed=12+random(4)
	my_id.image_angle=my_id.direction
	bullet2=instance_create(my_id.x,my_id.y,argument0)
	...
	my_id=instance_create(x+lengthdir_x(20,angle),y+lengthdir_y(20,angle),argument0)
	if instance_exists(my_id) {
	...
	my_id=instance_create(x+lengthdir_x(26,angle-16),y+lengthdir_y(26,angle-16),argument0)
	if instance_exists(my_id) {
