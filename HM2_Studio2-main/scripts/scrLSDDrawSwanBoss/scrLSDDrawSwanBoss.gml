function scrLSDDrawSwanBoss() {
	...
	draw_sprite_ext(sprite_index,image_index,x+myx,y+myy,image_xscale,image_yscale,image_angle,image_blend,image_alpha)
	...
	draw_sprite_ext(sprSwanNeck,index,myx,myy,1,1,mydir+addir,c_white,1)
	...
	if init=0 draw_sprite_ext(sprSwanNeck,0,myx,myy,point_distance(myx,myy,x,y)*(1/22),1,point_direction(myx,myy,x,y),c_white,1)
	dir=tempdir
	}
	...
	draw_sprite_ext(sprSwanNeck,0,myx,myy,point_distance(myx,myy,x,y)*(1/22),1,point_direction(myx,myy,x,y),c_white,1)
	} else {
	repeat (times) {
	if i=0 index=1 else index=0
	if i=times-1 index=2
